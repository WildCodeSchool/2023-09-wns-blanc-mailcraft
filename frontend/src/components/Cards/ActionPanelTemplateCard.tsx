...
const ActionPanelTemplateCard: React.FC<ActionPanelTemplateCardProps> = ({ templateId, showDataPanel, onTogglePanel }) => {
    ...
    return (
        <div className="action-panel h-[90%] w-12 xl:w-16 bg-[#9F3D3D] flex flex-col rounded-s-md">
            ...
            <div className="flex flex-col items-center justify-center gap-12 mb-7 flex-grow">
                ...
                <button className="mb-2 text-white hover:text-gray-300" onClick={handleDelete}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
