    ...
    <>
      ...
      >
        {(provided) => (
          ...
          >
            <button className="absolute top-2 right-2" onClick={() => handleResetZones("template")}>
              ...
              <Draggable key={zone.id} draggableId={zone.id} index={index}>
                {(providedZone, snapshotZone) => (
                  <div
                    ...
                    className={`zone ${snapshotZone.isDragging ? 'opacity-50' : ''} flex flex-col gap-2.5 p-5 border-2 border-dashed border-gray-400 mb-5`}
                  >
                    <Droppable
                      droppableId={zone.id}
                                            ...
                                            >
                                              ...
                                              {subZone.moduleType === 'texte' && (
                                                <textarea
                                                  ...
                                                  onChange={(e) => handleTextChange(e, zone.subZones, subZone.id, 'template')}
