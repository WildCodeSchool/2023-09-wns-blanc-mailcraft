        ...
        <div>
          ...
          <div className="flex bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-sm">
            {styleIcons.map((icon, index) => (
              <div
                key={index}
                className={`styleIcon flex-1 ${
                  index === styleIcons.length - 1 ? "" : "border-r"
                } border-gray-300 flex justify-center items-center cursor-pointer ${
                  selectedStyleIconIndex === index ? "bg-gray-300" : ""
                }`}
        ...
        <div>
          ...
          <div className="flex bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-sm">
            {justificationIcons.map((icon, index) => (
              <div
                key={index}
                className={`justificationIcon ${
                  index === justificationIcons.length - 1 ? "" : "border-r"
                } flex-1 border-gray-300 flex justify-center items-center cursor-pointer ${
                  selectedJustificationIconIndex === index ? "bg-gray-300" : ""
                }`}
