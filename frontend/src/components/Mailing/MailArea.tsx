  ...
  return (
    <section className="flex flex-col h-full w-full sm:w-[90%] md:w-[70%] lg:w-[60%] mx-auto mt-1 border-[1px] border-gray-200 rounded-lg shadow-sm">
      ...
      <div className="flex flex-col bg-white rounded-b-lg shadow p-6">
        <div className="flex flex-col sm:flex-row items-center mb-4">
          <label
            ...
            htmlFor="to"
            className="block text-lg font-medium text-gray-700 w-full sm:w-1/6"
          >
            À :
          </label>
          <input
             placeholder="Destinataire du mail"
            type="text"
            id="recipient"
            onChange={(e) => handleRecipientChange(e)}
            className="focus:border-gray-200 bg-white font-semibold mt-1 block w-full sm:w-2/6 px-3 py-2 border border-gray-300 rounded-md shadow-sm   sm:text-sm "
          />
        </div>
        <div className="flex flex-col sm:flex-row items-center mb-4 border-b border-gray-500 pb-8">
          <label
            htmlFor="subject"
            className="block text-lg font-medium text-gray-700 w-full sm:w-1/6"
          >
          ...
          <input
            ...
            className="focus:border-gray-200 bg-white font-semibold mt-1 block w-full sm:w-3/6 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-customPink focus:border-customPink sm:text-sm"
          />
        </div>
        ...
        <Droppable droppableId="templateHtml">
          {(provided) => (
            <div
              id="templateHtml"
              className="relative flex justify-center items-center h-80 border border-gray-300 rounded-md overflow-hidden"
      ...
      <Modal
        ...
        className="sm:w-96 xl:w-[95%] xl:mt-4  mx-auto"
      >
        ...
        <div
          ...
          className="p-4 border border-gray-400 rounded-md bg-customBrown"
        ></div>
        <button
          onClick={closeModal}
          className="mt-4 mb-4 px-4 py-2 bg-red-600 text-white font-medium rounded-md mx-auto hover:bg-red-700 flex items-center shadow-lg "
        >
