  ...
  return (
    ...
    >
      {showPassword ? (
        ...
        >
          <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">Mot de passe oublié ?</p>
        </button>
        </div>
      ...
      <div className="flex items-center">
        <a href="/signUp" className="text-sm italic hover:underline">Pas de compte ? Inscrivez-vous.</a>
      </div>
