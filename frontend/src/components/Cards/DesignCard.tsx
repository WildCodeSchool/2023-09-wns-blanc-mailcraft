...
export default function DesignCard() {
  ...
  return (
    <div className="w-72 max-w-sm p-4 bg-red-500 border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
      <form className="space-y-6" action="#">
        <h5 className="text-xl font-medium text-gray-900 text-center">Design</h5>
        <div>
          <label htmlFor="police" className="block mb-2 text-md font-medium text-gray-900">Police</label>
          <input type="text" name="police" id="police" placeholder="Arial" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
        </div>
        <div>
          <label htmlFor="size" className="block mb-2 text-md font-medium text-gray-900">Taille</label>
          <input type="text" name="size" id="size" placeholder="12" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
        </div>
        <div>
          <label htmlFor="color" className="block mb-2 text-md font-medium text-gray-900">Couleur</label>
          <input type="text" name="color" id="color" placeholder="Black" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
        </div>
        <div>
          <label htmlFor="style" className="block mb-2 text-md font-medium text-gray-900">Style</label>
          <div className="flex bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 text-sm">
        ...
        <div>
          <label htmlFor="justification" className="block mb-2 text-ms font-medium text-gray-900">Justification</label>
          <div className="flex bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 text-sm">
